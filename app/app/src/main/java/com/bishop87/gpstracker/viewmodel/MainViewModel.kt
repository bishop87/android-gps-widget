...
import com.bishop87.gpstracker.domain.usecase.StartTrackingUseCase
import com.bishop87.gpstracker.domain.usecase.StopTrackingUseCase
...
class MainViewModel(app: Application) : AndroidViewModel(app) {
    ...
    fun toggleOverlay(enabled: Boolean) {
        ...
        val intent = android.content.Intent(getApplication(), com.bishop87.gpstracker.service.OverlayService::class.java)
        if (enabled) {
