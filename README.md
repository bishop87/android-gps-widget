...
- **Interactive Map:** A dedicated map screen (powered by OpenStreetMap via Osmdroid) to visualize your tracked routes, filter by date, click on data points for details, and export the routes to a local CSV file.
...
- **Key Libraries:** FusedLocationProviderClient, WorkManager, Retrofit/OkHttp, EncryptedSharedPreferences, Osmdroid
