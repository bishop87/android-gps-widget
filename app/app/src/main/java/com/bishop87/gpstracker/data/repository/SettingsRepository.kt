package com.bishop87.gpstracker.data.repository
...
import com.bishop87.gpstracker.data.preferences.SettingsKeys
...
class SettingsRepository(val context: Context) {
    ...
    fun getMapApiUrl(): String =
        prefs.getString(SettingsKeys.MAP_API_URL, "") ?: ""
}
