...
import com.bishop87.gpstracker.BuildConfig
import com.bishop87.gpstracker.R
import com.bishop87.gpstracker.databinding.ActivityMainBinding
import com.bishop87.gpstracker.util.BatteryOptimizationHelper
import com.bishop87.gpstracker.util.PermissionHelper
import com.bishop87.gpstracker.viewmodel.MainViewModel
import com.bishop87.gpstracker.viewmodel.UiState
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupObservers() {
        ...
        viewModel.statusMessage.observe(this) { message ->
            // Mostra toast solo se c'è un messaggio utile (Skippa i messaggi base come "Pronto")
            if (message != getString(R.string.status_idle) && 
                message != getString(R.string.status_acquiring) && 
                message != getString(R.string.status_sending)) {
