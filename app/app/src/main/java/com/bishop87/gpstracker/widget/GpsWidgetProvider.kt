...
class GpsWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_WIDGET_TAP = "com.bishop87.gpstracker.ACTION_WIDGET_TAP"
        ...
        fun updateWidget(
            ...
            val settingsRepo = com.bishop87.gpstracker.data.repository.SettingsRepository(context)
